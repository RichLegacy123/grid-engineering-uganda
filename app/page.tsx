    ...
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section id="electrical" className="py-16 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {electricalServices.map((service, i) => (
              <div key={i} className="bg-white p-6 rounded-lg shadow hover:shadow-lg border-gray-200 hover:border-blue-600 transition flex items-center justify-center min-h-[80px]">
                <h3 className="font-semibold text-lg text-gray-900 text-center">{service}</h3>
              </div>
            ))}
          </div>
      ...
      <section id="mechanical" className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {mechanicalServices.map((service, i) => (
              <div key={i} className="bg-gray-50 p-6 rounded-lg shadow hover:shadow-lg border-gray-200 hover:border-blue-600 transition flex items-center justify-center min-h-[80px]">
                <h3 className="font-semibold text-lg text-gray-900 text-center">{service}</h3>
              </div>
            ))}
          </div>
